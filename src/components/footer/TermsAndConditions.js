...
function TermsAndConditions() {
  return (
    ...
    <Container className="mainPageContainer">
      ...
      <p>Aenean commodo fermentum nunc non ultrices. Quisque cursus nec elit sit amet venenatis. Mauris turpis nisl, malesuada eu elit blandit, elementum bibendum orci. Mauris elit diam, fringilla at luctus vitae, vestibulum ac nisi. Aliquam erat volutpat. Morbi velit justo, sollicitudin vitae efficitur vitae, pharetra vitae est. Suspendisse vehicula lacus non quam porta feugiat. Duis id efficitur arcu, nec blandit lorem.</p>
    </Container>
